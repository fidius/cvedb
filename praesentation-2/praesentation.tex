...
\secframe{Ziele}{
  \begin{itemize}
    \item Wir können die von der NVD bereitgestellten XML-Dateien parsen und die
Daten in Ruby-Objekten vorhalten. \checkmark
...
\secframe{Fidius-CVEinit-GEM}{
  \begin{itemize}
    ...
    \begin{itemize}
     ...
     \item Erstellt Models, Migrations, Rake-Taks,...
    \end{itemize}
  \end{itemize}
}
...
\secframe{Suche}{
  \begin{itemize}
    ...
    \subitem{vendor - product - version - update\_nr - edition - language}
    \subitem{z.B: apache - http\_server - 1.3.11 - NULL - win32 - NULL}
    \subitem{z.B: microsoft - windows\_2003\_server - NULL - sp2 - itanium}
